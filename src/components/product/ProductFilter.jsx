...
const ProductFilter = ({ price, setPrice, categories, setCategories,allCategories }) => {
      ...
      <div className="w-full border-b border-[#b2b1b1] px-2">
        ...
        <ul className="w-full">
          {allCategories?.map((cat) => (
            <li
              key={cat._id}
              className="flex items-center gap-3 px-2 py-2 hover:bg-[rgb(255,187,56)] transition-all duration-300 ease-in-out"
            >
              <input
                type="checkbox"
